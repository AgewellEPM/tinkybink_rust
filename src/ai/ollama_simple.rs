...
impl SimpleOllamaEngine {
    ...
    fn get_fallback_responses(&self, input: &str) -> Vec<AiResponse> {
        ...
        if input_lower.contains("park") || input_lower.contains("outside") {
            vec![
                AiResponse { text: "Yes! Park!".to_string(), emoji: "🏞️".to_string(), confidence: 0.9, emotion: "excited".to_string() },
                AiResponse { text: "Stay home".to_string(), emoji: "🏠".to_string(), confidence: 0.8, emotion: "reluctant".to_string() },
                AiResponse { text: "Too cold".to_string(), emoji: "🥶".to_string(), confidence: 0.7, emotion: "concerned".to_string() },
                AiResponse { text: "Play inside?".to_string(), emoji: "🎮".to_string(), confidence: 0.7, emotion: "suggesting".to_string() },
            ]
        } else {
            vec![
                AiResponse { text: "Yes".to_string(), emoji: "✅".to_string(), confidence: 0.8, emotion: "positive".to_string() },
                AiResponse { text: "No".to_string(), emoji: "❌".to_string(), confidence: 0.8, emotion: "negative".to_string() },
                AiResponse { text: "Maybe".to_string(), emoji: "🤔".to_string(), confidence: 0.7, emotion: "unsure".to_string() },
                AiResponse { text: "I don't know".to_string(), emoji: "🤷".to_string(), confidence: 0.6, emotion: "confused".to_string() },
            ]
        }
    }
