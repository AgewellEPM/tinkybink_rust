...
impl EmojiMapper {
    ...
    fn initialize_mappings(&mut self) {
        let mappings = vec![
            ...
            ("chicken", "🍗"), ("fish", "🐟"), ("rice", "🍚"), ("soup", "🍲"), ("taco", "🌮"),
            ("sushi", "🍣"), ("steak", "🥩"), ("bacon", "🥓"), ("eggs", "🥚"), ("egg", "🥚"),
            ("bread", "🍞"), ("cheese", "🧀"), ("hotdog", "🌭"), ("fries", "🍟"), ("noodles", "🍜"),
            
            // === FOOD - Fruits & Vegetables ===
            ("apple", "🍎"), ("banana", "🍌"), ("orange", "🍊"), ("strawberry", "🍓"), ("grape", "🍇"),
            ("watermelon", "🍉"), ("pineapple", "🍍"), ("mango", "🥭"), ("peach", "🍑"), ("cherry", "🍒"),
            ("lemon", "🍋"), ("pear", "🍐"), ("avocado", "🥑"), ("tomato", "🍅"), ("carrot", "🥕"),
            ("corn", "🌽"), ("broccoli", "🥦"), ("potato", "🥔"), ("cucumber", "🥒"), ("pepper", "🌶️"),
            
            // === FOOD - Snacks & Desserts ===
            ("icecream", "🍦"), ("ice cream", "🍦"), ("cake", "🍰"), ("cookie", "🍪"), ("cookies", "🍪"),
            ("candy", "🍬"), ("chocolate", "🍫"), ("donut", "🍩"), ("doughnut", "🍩"), ("pie", "🥧"),
            ("cupcake", "🧁"), ("popcorn", "🍿"), ("pretzel", "🥨"), ("chips", "🍟"), ("crackers", "🧈"),
            
            // === DRINKS ===
            ("water", "💧"), ("juice", "🧃"), ("milk", "🥛"), ("coffee", "☕"), ("tea", "🍵"),
            ("soda", "🥤"), ("pop", "🥤"), ("smoothie", "🥤"), ("lemonade", "🍋"), ("beer", "🍺"),
            ("wine", "🍷"), ("cocktail", "🍹"), ("champagne", "🍾"), ("shake", "🥤"), ("milkshake", "🥤"),
            
            // === PLACES ===
            ("home", "🏠"), ("house", "🏠"), ("school", "🏫"), ("store", "🏪"), ("mall", "🏬"),
            ("restaurant", "🍽️"), ("hospital", "🏥"), ("library", "📚"), ("gym", "🏋️"), ("beach", "🏖️"),
            ("park", "🌳"), ("playground", "🎠"), ("office", "🏢"), ("church", "⛪"), ("museum", "🏛️"),
            ("hotel", "🏨"), ("airport", "✈️"), ("station", "🚉"), ("theater", "🎭"), ("cinema", "🎬"),
            ("pool", "🏊"), ("bathroom", "🚽"), ("toilet", "🚽"), ("bedroom", "🛏️"), ("kitchen", "🍳"),
            
            // === ACTIVITIES & HOBBIES ===
            ("play", "🎮"), ("game", "🎮"), ("read", "📖"), ("book", "📚"), ("watch", "📺"),
            ("tv", "📺"), ("television", "📺"), ("movie", "🎬"), ("music", "🎵"), ("sing", "🎤"),
            ("dance", "💃"), ("draw", "🎨"), ("paint", "🎨"), ("art", "🎨"), ("write", "✍️"),
            ("sleep", "😴"), ("nap", "😴"), ("rest", "😴"), ("walk", "🚶"), ("run", "🏃"),
            ("swim", "🏊"), ("bike", "🚴"), ("bicycle", "🚴"), ("exercise", "💪"), ("sport", "⚽"),
            
            // === TIME ===
            ("now", "⏰"), ("later", "⏳"), ("today", "📅"), ("tomorrow", "📆"), ("yesterday", "📆"),
            ("morning", "🌅"), ("afternoon", "☀️"), ("evening", "🌆"), ("night", "🌙"), ("midnight", "🌙"),
            ("monday", "📅"), ("tuesday", "📅"), ("wednesday", "📅"), ("thursday", "📅"), ("friday", "📅"),
            ("saturday", "📅"), ("sunday", "📅"), ("weekend", "📅"), ("weekday", "📅"), ("week", "📅"),
            
            // === PEOPLE & RELATIONSHIPS ===
            ("mom", "👩"), ("mother", "👩"), ("dad", "👨"), ("father", "👨"), ("parent", "👨‍👩‍👧"),
            ("sister", "👧"), ("brother", "👦"), ("baby", "👶"), ("grandma", "👵"), ("grandpa", "👴"),
            ("friend", "👫"), ("teacher", "👩‍🏫"), ("doctor", "👨‍⚕️"), ("nurse", "👩‍⚕️"), ("family", "👨‍👩‍👧‍👦"),
            
            // === EMOTIONS & STATES ===
            ("happy", "😊"), ("sad", "😢"), ("angry", "😠"), ("mad", "😡"), ("tired", "😴"),
            ("sick", "🤒"), ("hungry", "🍽️"), ("thirsty", "💧"), ("excited", "🤗"), ("scared", "😨"),
            ("love", "❤️"), ("like", "👍"), ("hate", "👎"), ("confused", "😕"), ("bored", "😑"),
            
            // === COMMON ITEMS ===
            ("phone", "📱"), ("computer", "💻"), ("tablet", "📱"), ("car", "🚗"), ("bus", "🚌"),
            ("train", "🚂"), ("bike", "🚲"), ("toy", "🧸"), ("ball", "⚽"), ("game", "🎮"),
            ("clothes", "👕"), ("shoes", "👟"), ("hat", "🧢"), ("glasses", "👓"), ("bag", "👜"),
            
            // === WEATHER ===
            ("sun", "☀️"), ("sunny", "☀️"), ("rain", "🌧️"), ("rainy", "🌧️"), ("snow", "❄️"),
            ("snowy", "❄️"), ("cloud", "☁️"), ("cloudy", "☁️"), ("wind", "💨"), ("windy", "💨"),
            ("hot", "🔥"), ("cold", "🥶"), ("warm", "☀️"), ("cool", "❄️"), ("storm", "⛈️"),
            ...
            ("good", "👍"), ("bad", "👎"), ("stop", "🛑"), ("go", "🟢"), ("wait", "⏳"),
            ("help", "🆘"), ("please", "🙏"), ("thanks", "🙏"), ("thank you", "🙏"), ("sorry", "😔"),
            
            // === ACTIONS ===
            ("come", "👋"), ("go", "🚶"), ("sit", "🪑"), ("stand", "🧍"), ("lie", "🛏️"),
            ("open", "🔓"), ("close", "🔒"), ("turn on", "🔛"), ("turn off", "📴"), ("start", "▶️"),
            ("finish", "✅"), ("begin", "🚀"), ("end", "🔚"), ("continue", "⏩"), ("pause", "⏸️"),
            
            // === QUANTITIES ===
            ("more", "➕"), ("less", "➖"), ("many", "🔢"), ("few", "🔢"), ("all", "💯"),
            ("some", "🤏"), ("none", "❌"), ("big", "🔍"), ("small", "🔎"), ("huge", "🦣"),
            
            // === DIRECTIONS ===
            ("up", "⬆️"), ("down", "⬇️"), ("left", "⬅️"), ("right", "➡️"), ("here", "📍"),
            ("there", "👉"), ("near", "📍"), ("far", "🔭"), ("inside", "🏠"), ("outside", "🌳"),
        ];
